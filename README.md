![KLER Logo](kler-frontend/public/img/AtmoSense.png)
...
### Videós segítség a telepítéshez
```bash
https://www.youtube.com/watch?v=7SEfH36kWgE
```
...
[Kattints ide a tesztelési jegyzőkönyv letöltéséhez](./Frontend%20Tesztelés.docx)
